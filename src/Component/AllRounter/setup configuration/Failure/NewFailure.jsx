    ...
    const postapi = (e) => {
        ...
        axios.post(`/api/Failure_post`, {
            ...
            .catch((err) => {
                Swal.fire(
                    'Error!',
                    'This Failure Code already exist',
                    'error'
                ).then((result) => {
                    if (result.isConfirmed) {
                        setvalue(prevState => ({ ...prevState, FailureStatusCode: '', FailureStatusDesc: '' }));
                    ...
                    <div className="row mx-auto  w-100 formsection sizingtop">
                        <div className="col-sm-12 col-md-5 col-lg-5 col-xl-5">
                            <div className='emailsection position-relative d-grid my-1'>
                                <label htmlFor='FailureStatusCode' className='lablesection color3 text-start mb-1'>
                                    FailureStatus Code<span className='star'>*</span>
                                </label>
                                ...
                                <input
                                    ...
                                    onChange={e => {
                                        setvalue(prevValue => ({
                                            ...prevValue,
                                            FailureStatusCode: e.target.value
                                        }))
                                    }}
                                    className='rounded inputsection py-2 px-2'
                                    placeholder='FailureStatusCode'
                                    required
                                ></input>
                            </div>
                        </div>
                        ...
                        <div className="col-sm-12 col-md-7 col-lg-7 col-xl-7">
                            <div className='emailsection position-relative d-grid my-1'>
                                <label htmlFor='FailureStatusDesc' className='lablesection color3 text-start mb-1'>
                                    FailureStatus Desc <span className='star'>*</span>
                                </label>

                                <input
                                    types='text'
                                    id='FailureStatusDesc'
                                    value={value.FailureStatusDesc}
                                    onChange={e => {
                                        setvalue(prevValue => ({
                                            ...prevValue,
                                            FailureStatusDesc: e.target.value
                                        }))
                                    }}
                                    className='rounded inputsection py-2 px-2'
                                    placeholder='FailureStatusDesc'
                                    required
                                ></input>
                            </div>
                        </div>

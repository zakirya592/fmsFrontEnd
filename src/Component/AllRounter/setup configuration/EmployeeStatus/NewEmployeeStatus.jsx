    ...
    const postapi = (e) => {
        ...
        axios.post(`api/EmployeeStatus_post`, {
            ...
            .then((res) => {
                ...
                setvalue(prevState => ({ ...prevState, EmployeeStatusCode: '', EmployeeStatusDesc: '' }));
                // setAnchorEl(null);
                setOpenDialog(false);
            ...
            .catch((err) => {
                ...
                Swal.fire(
                    ...
                    if (result.isConfirmed) {
                     setvalue(prevState => ({ ...prevState, EmployeeStatusCode: '', EmployeeStatusDesc: '' }));    // Perform the redirect after clicking "OK"
                    }
                });
                setOpenDialog(false);
            });
                    ...
                    <div className="row mx-auto w-100 formsection sizingtop">
                        <div className="col-sm-12 col-md-5 col-lg-5 col-xl-5">
                            <div className='emailsection position-relative d-grid my-1'>
                                <label htmlFor='EmployeeStatusCode' className='lablesection color3 text-start mb-1'>
                                Employee Status Code<span className='star'>*</span>
                                </label>

                                <input
                                    types='text'
                                    id='EmployeeStatusCode'
                                    value={value.EmployeeStatusCode}
                                    onChange={e => {
                                        setvalue(prevValue => ({
                                            ...prevValue,
                                            EmployeeStatusCode: e.target.value
                                        }))
                                    }}
                        ...
                        <div className="col-sm-12 col-md-7 col-lg-7 col-xl-7">
                            <div className='emailsection position-relative d-grid my-1'>
                                ...
                                Employee Status Desc <span className='star'>*</span>
                                </label>
                                ...
                                <input
                                    ...
                                    onChange={e => {
                                        setvalue(prevValue => ({
                                            ...prevValue,
                                            EmployeeStatusDesc: e.target.value
                                        }))
                                    }}
                                    className='rounded inputsection py-2 px-2' 
...
export default NewEmployeeStatus
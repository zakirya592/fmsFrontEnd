...
function Maritalstatus() {
    ...
    const [MaritalDesc, setMaritalDesc] = useState()
        ...
        { field: 'MaritalDesc', headerName: 'DESCRIPTION', width: 350 },
        {
            ...
            renderCell: (params) => (
                <div>
                    ...
                    <button type="button" className="btn  mx-1 color2 btnwork" onClick={() => Deletedapi(params.row.MaritalCode)}>
                        <DeleteOutlineIcon />
                    </button>
                </div>
            ),
    ...
    function updata(MaritalCode) {
        ...
        axios.get(`/api/MaritalStatus_GET_BYID/${MaritalCode}`, {
            ...
            .then((res) => {
                ...
                setMaritalDesc(res.data.recordset[0].MaritalDesc)
                setItemCode(MaritalCode); // Store the WorkTypeCode in state
            })
            .catch((err) => {
                console.log(err);
    ...
    const postapi = (e) => {
        ...
        axios.put(`/api/MaritalStatus_Put/${itemCode}`, {
                    ...
                    <div className="topermaringpage  container">
                        <div className="py-3">
                            <div className="d-flex justify-content-between my-auto">
                                <p className="color1 workitoppro my-auto">MARITAL STATUS MAINTENANCE

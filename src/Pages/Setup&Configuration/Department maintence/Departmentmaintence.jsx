...
function Departmentmaintence() {
    ...
    const columns = [
        ...
        { field: 'DepartmentCode', headerName: 'DEPARTMENT CODE', width: 230 },
            ...
            reader.onload = (e) => {
                ...
                json.forEach((item) => {
                    axios.post(`/api/Department_post`, {
                        DepartmentCode: item.DepartmentCode, // Adjust property names as needed
                        ...
                        .catch((err) => {
                            ...
                            Swal.fire(
                                'Error!',
                                `Some Department code already exist`,
                                'error'
                            )
                            // Handle errors
                        });
                  ...
                  <div className="topermaringpage  container">
                      <div className="py-3">
                          <div className="d-flex justify-content-between my-auto">
                              <p className="color1 workitoppro my-auto">DEPARTMENT CODE
...
export default Departmentmaintence
            ...
            reader.onload = (e) => {
                ...
                json.forEach((item) => {
                    ...
                    axios.post(`/api/Solution_post`, {
                        SolutiontatusCode: item.SolutiontatusCode, // Adjust property names as needed
                        SolutionStatusDesc: item.SolutionStatusDesc,
                    })
                        .then((res) => {
                            console.log('Add', res.data);
                            // Handle success
                            Swal.fire(
                                'Add!',
                                `SolutionStatus has been created`,
                                'success'
                            )
                            getapi()
                        })
                        .catch((err) => {
                            ...
                            Swal.fire(
                                'Error!',
                                `Some SolutionStatus already exist`,
                                'error'
                            )
                            // Handle errors
                        });

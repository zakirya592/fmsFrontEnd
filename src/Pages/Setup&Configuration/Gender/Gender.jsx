...
function Gender() {
    ...
    const Deletedapi = (GenderCode) => {
        ...
        swalWithBootstrapButtons.fire({
            title: 'Are you sure?',
            text: `You want to delete this ${GenderCode} Gender`,
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                ...
                swalWithBootstrapButtons.fire(
                    'Deleted!',
                    `Gender ${GenderCode} has been deleted`,
                    'success'
                )
            }
        })
    ...
    const columns = [
        ...
        { field: 'GenderCode', headerName: 'GENDER STATUS CODE', width: 230 },
        { field: 'GenderDesc', headerName: 'DESCRIPTION', width: 350 },
        {
            field: 'action',
            headerName: 'ACTION',
            width: 170,
            renderCell: (params) => (
                <div>
                    <button type="button" className="btn  mx-1 color2 btnwork" onClick={() => updata(params.row.GenderCode)}>
                    ...
                    <button type="button" className="btn  mx-1 color2 btnwork" onClick={() => Deletedapi(params.row.GenderCode)}>
                        <DeleteOutlineIcon />
                    </button>
                </div>
            ),
    ...
    function updata(GenderCode) {
        ...
        axios.get(`/api/Gender_GET_BYID/${GenderCode}`, {
            ...
            .then((res) => {
                ...
                setGenderDesc(res.data.recordset[0].GenderDesc)
                setItemCode(GenderCode); // Store the WorkTypeCode in state
            })
            .catch((err) => {
                console.log(err);
    ...
    const postapi = (e) => {
        ...
        axios.put(`/api/Gender_Put/${itemCode}`, {
            FreqSeq: FreqSeq,
            ...
            .then((res) => {
                ...
                Swal.fire(
                    'Update!',
                    `Gender ${itemCode} has been updated`,
                    'success'
                ).then(() => {
                    handleClose();
                });
            ...
            reader.onload = (e) => {
                ...
                json.forEach((item) => {
                    ...
                    axios.post(`/api/Gender_post`, {
                        GenderCode: item.GenderCode, // Adjust property names as needed
                    ...
                    <div className="topermaringpage  container">
                        <div className="py-3">
                            <div className="d-flex justify-content-between my-auto">
                                <p className="color1 workitoppro my-auto">GENDER STATUS MAINTENANCE*
                    ...
                    <div class="modal-dialog bgupdata" style={{ borderRadius: '10px', border: '4px solid #1E3B8B' }}>
                        <div class="modal-content bgupdata">
                            <div class="modal-header">
                                <h5 class="modal-title" id="staticBackdropLabel">Updata Gender </h5>
                                ...
                                <form onSubmit={postapi}>
                                    ...
                                    <div className='emailsection position-relative d-grid my-3'>
                                        <label htmlFor='GenderDesc' className='lablesection color3 text-start mb-1'>
                                            GenderDesc<span className='star'>*</span>
                                        </label>

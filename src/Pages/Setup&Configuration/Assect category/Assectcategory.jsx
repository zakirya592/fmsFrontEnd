...
function Assectcategory() {
    const columns = [
        { field: 'id', headerName: 'SEQ.', width: 150 },
        { field: 'workTrade', headerName: 'ASSET CATEGORY', width: 270 },
                    ...
                    <div className="topermaringpage  container">
                        <div className="py-3">
                            <div className="d-flex justify-content-between my-auto">
                                <p className="color1 workitoppro my-auto">ASSET  CATEGORY MAINTENANCE

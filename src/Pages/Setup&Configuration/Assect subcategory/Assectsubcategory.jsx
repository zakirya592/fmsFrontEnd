...
function AssetSubCategory() {
    ...
    const [AssetSubCategoryDesc, setAssetSubCategoryDesc] = useState()
    ...
    const Deletedapi = (AssetSubCategoryCode) => {
        console.log(AssetSubCategoryCode);
        ...
        { field: 'AssetSubCategoryDesc', headerName: 'DESCRIPTION', width: 350 },
        {
            ...
            renderCell: (params) => (
                <div>
                    ...
                    <button type="button" className="btn  mx-1 color2 btnwork" onClick={() => Deletedapi(params.row.AssetSubCategoryCode)}>
                        <DeleteOutlineIcon />
                    </button>
                </div>
            ),
    ...
    const filteredData = getdata && getdata.map((row, indes) => ({
        ...
        id: indes + 1,
        // SEQ:row.EmployeeID,
        AssetSubCategoryCode: row.AssetSubCategoryCode,
        AssetSubCategoryDesc: row.AssetSubCategoryDesc

    }))

    // Updata section
    // GEt by id Api
    function updata(AssetSubCategoryCode) {
        console.log(AssetSubCategoryCode);
        ref.current.click()
        // get api
        axios.get(`/api/AssetSubCategory_GET_BYID/${AssetSubCategoryCode}`, {
            ...
            .then((res) => {
                ...
                setAssetSubCategoryDesc(res.data.recordset[0].AssetSubCategoryDesc)
                setItemCode(AssetSubCategoryCode); // Store the WorkTypeCode in state
            })
            .catch((err) => {
                console.log(err);
    ...
    const postapi = (e) => {
        ...
        axios.put(`/api/AssetSubCategory_Put/${itemCode}`, {
                    ...
                    <div className="topermaringpage  container">
                        <div className="py-3">
                            <div className="d-flex justify-content-between my-auto">
                                <p className="color1 workitoppro my-auto">ASSET SUB-CATEGORY MAINTANENECE
                            ...
                            <form onSubmit={postapi}>
                                <div className='emailsection position-relative d-grid my-1'>
                                    ...
                                    <input
                                        ...
                                        value={AssetSubCategoryDesc}
                                        onChange={e => {
                                            setAssetSubCategoryDesc(e.target.value)
                                        }}

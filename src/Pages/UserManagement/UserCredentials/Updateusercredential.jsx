        ...
        axios.get(`/api/UserCredentials_GET_BYID/${userId}`)
            .then((res) => {
                ...
                setvalue((prevValue) => ({
                    ...
                    userIdPassword: res.data.recordset[0].UserPassword,
                    windowuserid: res.data.recordset[0].WindowsID,
                    windowuserpassword: res.data.recordset[0].WindowsPassword,
                    emailAddress: res.data.recordset[0].CreatedByAdminID,
    ...
    const addtransaction = async () => {
        axios.put(`/api/UserCredentials_Put/${userId}`, {
            ...
            .then((res) => {
                ...
                Swal.fire(
                    'Success!',
                    `User Credentials ${userId} has been updated`,
                    'success'
                )
                        ...
                        <div className="topermaringpage mb-4 container">
                            <div className="py-3">
                                ...
                                <div className="d-flex justify-content-between my-auto">
                                    <p className='color1 workitoppro my-auto'> User Credentials - Update
                                    </p>
                                </div>

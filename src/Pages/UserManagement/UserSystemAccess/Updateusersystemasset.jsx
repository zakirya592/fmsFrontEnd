...
function Updateusersystemasset() {
    ...
    const Createapi = async () => {
        axios.put(`/api/UserSystemAccess_Put/${userId}`, {
            ...
            .then((res) => {
                ...
                Swal.fire(
                    'Success!',
                    `User SystemAccess ${userId} has been been updated `,
                    'success'
                )
                        ...
                        <div className="topermaringpage mb-4 container">
                            <div className="py-3">
                                ...
                                <div className="d-flex justify-content-between mt-3">
                                    ...
                                    <button type="button" className="border-0 px-3 mx-2  savebtn py-2" onClick={Createapi}><SaveIcon className='me-2' />SAVE</button>
                                </div>
                            </div>
                        </div>
                    </Box>
...
export default Updateusersystemasset
...
function AddGoodsreceiption() {
    ...
    const putapi = (AssetItemDescription) => {
        ...
        const assetcodeid = localStorage.getItem('Updatagoodsreseciption') || localStorage.getItem('Addgoodsreseciption');
            ...
            if (result.isConfirmed) {
                axios.post(`/api/assetItemGOODS_ADD_post`, {
                    ...
                    .then((res) => {
                        ...
                        swalWithBootstrapButtons.fire(
                            'Add!',
                            `The selected records are added to the Goods Receipts :${localStorage.getItem('Updatagoodsreseciption') || localStorage.getItem('Addgoodsreseciption')} `,
                            'success'
                        )
                    })
                    .catch((err) => {
    ...
    const Navigatepage = () => {
        const employeeIDss = localStorage.getItem('Updatagoodsreseciption');
                                ...
                                <div className="py-3">
                                    ...
                                    <div className="row mx-auto my-auto formsection">
                                        ...
                                        <div className="col-sm-2 col-md-3 col-lg-3 col-xl-3 my-auto">
                                            {/* <p></p> */}
                                            <button type="button" className="border-0 px-3 mt-4 savebtn py-2" onClick={handleAddToWorkRequest}><AddCircleOutlineIcon className='me-2' />Add To Goods Receipts</button>
                                        </div>
                                        <div className="col-sm-2 col-md-3 col-lg-3 text-end col-xl-3 my-auto">
                                            <p></p>
                                            {/* <p></p> */}
                                            <p className='mt-4 fs-5 fw-bolder color3 font-monospace mt-4'>{localStorage.getItem('Updatagoodsreseciption') || localStorage.getItem('Addgoodsreseciption')}</p>
...
export default AddGoodsreceiption;

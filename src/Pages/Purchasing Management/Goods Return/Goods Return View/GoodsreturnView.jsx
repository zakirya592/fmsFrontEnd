...
function GoodsreturnView() {
    ...
    const apiget = () => {
        axios.get(`/api/GET_BY_PurchaseOrderNumber_GoodsReturn/${userId}`)
            .then((res) => {
                        ...
                        <div className="topermaringpage mb-4 container">
                            <div className="py-3">
                                ...
                                <div className="d-flex justify-content-between my-auto">
                                    <p className='color1 workitoppro my-auto'>View Goods Return</p>
                                </div>
                                ...
                                <div className="row mx-auto formsection">
                                    ...
                                    <div className="col-sm-3 my-auto col-md-10 col-lg-3 col-xl-3 ">
                                        <button type="button" className="btn btn-outline-primary color2 btnwork mt-3" disabled> <AddCircleOutlineIcon className='me-1' />Add Goods Return</button>
                                    </div>

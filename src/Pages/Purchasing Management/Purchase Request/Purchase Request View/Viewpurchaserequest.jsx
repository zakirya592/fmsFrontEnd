    ...
    const getapi = () => {
        axios.get(`/api/PurchaseRequest_GET_BYID/${userId}`, {
            ...
            .then((res) => {
                ...
                setvalue((prevValue) => ({
                    ...prevValue,
                    completeEmployee: res.data.recordset[0].RequestByEmployeeID,
                ...
                axios.post(`/api/getworkRequest_by_EPID`, {
                    ...
                    setvalue((prevValue) => ({
                        ...prevValue,
                        CompleteEmployeeName: res.data.recordsets[0][0].Firstname,
                    }));
                })
                    .catch((err) => {
                        //// console.log(err);;
                ...
                const VerifiedByEmpled = res.data.recordset[0].VerifiedByEmpl
                axios.post(`/api/getworkRequest_by_EPID`, {
                    EmployeeID: VerifiedByEmpled,
                }).then((res) => {
                    setvalue((prevValue) => ({
                        ...prevValue,

...
function AddPurchaserequest() {
        ...
        swalWithBootstrapButtons.fire({
            ...
            if (result.isConfirmed) {
                axios.post(`/api/assetItemRequest_ADD_post`, {
                    PurchaseRequestNumber: assetcodeid,
                    ...
                    .then((res) => {
                        ...
                        swalWithBootstrapButtons.fire(
                            'Add!',
                            `The selected records are added to the Purchase Request:${localStorage.getItem('Updatapurachaserequest') || localStorage.getItem('addpurachaserequest')} `,
                            'success'
                        )
                    })
                    .catch((err) => {
    ...
    const Navigatepage = () => {
        const employeeIDss = localStorage.getItem('Updatapurachaserequest');
                                ...
                                <div className="py-3">
                                    ...
                                    <div className="row mx-auto my-auto formsection">
                                        ...
                                        <div className="col-sm-2 col-md-3 col-lg-3 text-end col-xl-3 my-auto">
                                            <p></p>
                                            {/* <p></p> */}
                                            <p className='mt-4 fs-5 fw-bolder color3 font-monospace mt-4'>{localStorage.getItem('Updatapurachaserequest') || localStorage.getItem('addpurachaserequest')}</p>
